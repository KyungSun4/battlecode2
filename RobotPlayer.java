...
public strictfp class RobotPlayer 
{
        ...
        try
       	{
        	...
        	//Sets the direction it wants to move based on the orientation to the bullet
            ...
            //Checks if the direction it wants to move is clear before moving. If false, it will check if it can move backwards
            //If that is also false it will move towards the bullet in attempt to make room to move away next turn
            if (rc.canMove(moveToAvoid))
            {
            	rc.move(moveToAvoid);
            }
            //In the future make a method to detect the next available rc.move() direction to replace these.
    ...
    // A couple of ways to do this, you could ask for the id of the robot as a param rather than location
